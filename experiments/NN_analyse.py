...
if __name__ == "__main__":
    ...
    model_path = '../models/DDPG_Angle_Position_Error_with_Control_rand_position_polelen01_0'
    ...
    # from utils.plot_utils import *
    # from networks.REINFORCE import PolicyNet
    # analyse_all_models_noise(model_path, figure_path, max_sigma=0.5, samplings=40, action_type='Discrete')
